...
The groundtruth for MSPR-mobile is in ["/gt"](https://github.com/msprITU/MobileTracking/tree/master/MSPR-mobile/gt) folder. Also; ["/rawdata"](https://github.com/msprITU/MobileTracking/tree/master/MSPR-mobile/rawdata) contains the video files as well as the accelerometer data from "Video Recorder" app.
